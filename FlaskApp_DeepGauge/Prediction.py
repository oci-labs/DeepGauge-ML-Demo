...
class Predict(object):
    ...
    def predict_online(cls, checkpoint_path,
                       ...
                       color_mode,
                       frame_ratio=1
		       ,filename="./uploads/gauge_scale_0.jpg"):
        ...
        with tf.Session() as session:
            ...
            #image=cv2.imread("./uploads/gauge_scale_0.jpg")
            ...
            #while (True):
                ...
                #r = requests.get('http://127.0.0.1:5000/image.jpg') # replace with your i$
                ...
                if circles is not None:
                    ...
                    img_path2 = path + 'latest_streaming_frame_annotated' + '.jpg'
                    cv2.imwrite(img_path2, cropped_frame)
            ...
            #cap.release()
            #logit_output=pred_logit[0]
            #label_output=str(pred_cat)
            cv2.destroyAllWindows()
            

            try:
                  pred_cat # does pred_cat exist in the current namespace
            except NameError:
                  pred_cat = 'nan' # nope


            try:
                  pred_logit # does pred_logit exist in the current namespace
            except NameError:
                  pred_logit = '-' # nope



        return (pred_cat,pred_logit[0],img_path2)
